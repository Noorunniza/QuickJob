                                ...
                                while($r=mysqli_fetch_array($sel)){
                                 ...
                                 <?php 
                                            if($status == 1){
                                                ?>
                                               <td>
                                                <a  style="text-decoration: none;" class='bt' type='submit' class="btn-submit" name='Deactivate'  href='./vacancystatus.php?action=e&id=<?php echo $id; ?>&status=0'>Deactivate
                                                ...
                                                ?>
                                               <td><a  style="text-decoration: none;" class='bt' type='submit' class="btn-submit" name='Activate' href='./vacancystatus.php?action=e&id=<?php echo $id; ?>&status=1'>Activate</button></td><br>
                                                <?php
                                            }
                                        ?>
                                  </td> 
