                            ...
                            if($sel->num_rows>0){
                                ...
                                <?php 
                                            if($status == 1){
                                                ?>
                                               <td>
                                                <a  style="text-decoration: none;" class='bt' type='submit' class="btn-submit" name='Deactivate'  href='../functions/status.php?action=e&email=<?php echo $g; ?>&status=0'>Deactivate
                                                ...
                                                ?>
                                               <td><a  style="text-decoration: none;" class='bt' type='submit' class="btn-submit" name='Activate' href='../functions/status.php?action=e&email=<?php echo $g; ?>&status=1'>Activate</button></td><br>
                                                <?php
                                            }
                                        ?>
                                  </td>
