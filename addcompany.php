                ...
                <div style="display: flex;justify-content: center; padding: 0px;">
                    <div style="width: 100%; margin-top: 10px; margin-left: 300px;">
                        ...
                        <table>
                            ...
                            $sel=$con->query("SELECT * FROM company");
                            if($sel->num_rows>0){
                                while($r=mysqli_fetch_array($sel)){
                                    ...
                                    $c=$r['phone'];
                                    $id = $r['id'];
                                    $imageName = $r['companyImage'];
                                    $status = $r['status'];
                                    ?>
                                    
                                    <tr>
                                    <td> <img style='width:100px;height:100px;' src='./assets/companyImages/<?php echo $imageName;?> '> </td>
                                    <td><?php echo $a?></td>
                                    <td><?php echo $b?></td>
                                    <td><?php echo $c?></td>
  ...
  <td> 
                                 ...
                                 <?php 
                                            if($status == 1){
                                                ?>
                                               <td>
                                                <a  style="text-decoration: none;" class='bt' type='submit' class="btn-submit" name='Deactivate'  href='./companystatus.php?id=<?php echo $id; ?>&status=0'>Deactivate
                                                ...
                                                ?>
                                               <td><a  style="text-decoration: none;" class='bt' type='submit' class="btn-submit" name='Activate' href='./companystatus.php?id=<?php echo $id; ?>&status=1'>Activate</button></td><br>
                                                <?php
                                            }
                                        ?>
                                  </td> 
                                   ...
                                   <!-- <button class='bt'type='submit' name='delete' value='$a'>delete</button><br></td> -->
                                    <td> <a style='text-decoration: none;'class='bt'type='submit' name='edit' href='./company/editcompany.php? id=<?php echo $id?>'>Edit</button>
                                    </form></td>
                                     </tr>
                                        <?php
