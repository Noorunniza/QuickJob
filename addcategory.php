        ...
        <div class="header">
                        ...
                        <table>
                            ...
                            if($sel->num_rows>0){
                                while($r=mysqli_fetch_array($sel)){
                                    ...
                                    <form method='POST'>
                                    <td> 
                                        <button class='bt' onclick='fn(<?php echo $id ;?>)' type='button' name='edit'> Edit</button>
                                    </td>
                                    </form>
                                     </tr>
                                     <?php 
            ...
            <!-- Add your list of companies here -->
                  ...
                  <script>
                        const fn = (id) => {
                                console.log(id);
                                window.location.replace(`./editcategory.php?id=${id}`);
                        }
                  </script>
</html>
