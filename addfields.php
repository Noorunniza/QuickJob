        ...
        <div class="header">
                ...
                <div style="display: flex;justify-content: center; padding: 0px;">
                    <div style="width: 100%; margin-top: 10px; margin-left: 300px;">
                        ...
                        <table>
                            ...
                            $sel=$con->query("SELECT * FROM `field`");
                            if($sel->num_rows>0){
                                while($r=mysqli_fetch_array($sel)){
                                    $id=$r['id'];
                                    $a=$r['name'];
                                    $b=$r['description'];
                                    $imageName = $r['fieldimage'];
                                    $status=$r['status'];
                                    ?>
                                    <tr>
                                    <td> <?php echo $a ?></td>
                                    <td> <?php echo $b ?></td>
                                    <td><img style='width:100px;height:100px;' src='./assets/filedImages/<?php echo $imageName;?>'></td>
                                    <td> 
                                         <?php 
                                            if($status == 1){
                                                ?>
                                 ...
                                 <?php 
                                            if($status == 1){
                                                ?>
                                               <td>
                                                <a  style="text-decoration: none;" class='bt' type='submit' class="btn-submit" name='Deactivate'  href='./fieldstatus.php?id=<?php echo $id; ?>&status=0'>Deactivate
                                                ...
                                                ?>
                                               <td><a  style="text-decoration: none;" class='bt' type='submit' class="btn-submit" name='Activate' href='./fieldstatus.php?id=<?php echo $id; ?>&status=1'>Activate</button></td><br>
                                                <?php
                                            }
                                        ?>
                                  </td> 
                                ...
                                <button class='bt'type='submit' name='delete' value='$a'>delete</button><br></td> -->
                                    <!-- <td> <button class='bt' onclick='fn($id)' type='button' name='edit'> Edit</button> -->
                                    <td> <a style='text-decoration: none;'class='bt'type='submit' name='edit' href='./editfiled.php? id=<?php echo $id?>'>Edit</button>
            ...
            <!-- Add your list of companies here -->
                ...
                <script>
                        const fn = (id) => {
                                console.log(id);
                                window.location.replace(`./editfiled.php?id=${id}`);
                        }
                  </script>
</html>