    ...
    <style>
      ...
      #nav1 {
        ...
        #hero {
            ...
            display: flex;
            justify-content:start;
            background-image: url('./assets/chart-graph-business-finance.jpg  ');
            background-size: cover;
            /* background-color: darkgray; */
            /* background-image: url('./quick-job-logo-template-design-letter-q-logo-fast-vector-38391217.jpg  '); */
            /* background-size: cover; */
...
<body>
    ...
    <div id="hero">
        ...
        width: 100%;
        justify-content:start;
         background-color:rgba(104, 106, 107, 0.721);     
          
           padding:300px;">

            <div style=width:50%>
                <h id="her_head">about us </h>
