                    ...
                    <div style="width: 100%; margin-top: 10px; margin-left: 300px;">
                        ...
                        <table>
                            ...
                            $sel=$con->query("SELECT 
                                              e.empid,e.gender,e.name,e.email,e.phone,e.address,c.name as cmpnyname,l.status FROM 
                                              employer e inner join company c on e.cmp_id = c.id
                                              inner join login l on e.email  = l.username");
                            if($sel->num_rows>0){
                                ...
                                <?php 
                                            if($status == 1){
                                                ?>
                                               <td>
                                                <a  style="text-decoration: none;" class='bt' type='submit' class="btn-submit" name='Deactivate'  href='./employer/empstatus.php?email=<?php echo $b; ?>&status=0'>Deactivate
                                                ...
                                                ?>
                                               <td><a  style="text-decoration: none;" class='bt' type='submit' class="btn-submit" name='Activate' href='./employer/empstatus.php?email=<?php echo $b; ?>&status=1'>Activate</button></td><br>
                                                <?php
                                            }
                                        ?>
                                  </td>
                                    <td><a style='text-decoration: none;'class='bt' type='submit' name='edit' href='./employer/editemployer.php? id= <?php echo $id; ?>'> Edit</a>
                                    </form></td>
                                     </tr>
                                     <?php 
                                }
